                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select form-select-sm" name="gender">
                                        ...
                                        <option value="MALE" <#if profileForm.gender!'MALE' == 'MALE'>selected</#if>>Мужской</option>
                                        <option value="FEMALE" <#if profileForm.gender!'MALE' == 'FEMALE'>selected</#if>>Женский</option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select form-select-sm" name="cityId">
                                        ...
                                        <#list cities as city>
                                            <option value="${city.id}" <#if profileForm.cityId?? && profileForm.cityId == city.id>selected</#if>>
                                                ${city.cityName}
                                            </option>
                                        </#list>
                                    </select>
